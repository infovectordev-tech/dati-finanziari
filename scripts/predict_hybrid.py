...
asset_sector_map = {
    ...
    "MBG.DE": "4. Automotive & Mobility", "SPACEX": "7. Industrials & Defense",
...
symbol_name_map = {
    ...
    "PYPL": ["PayPal"],
    "SPACEX": ["SpaceX", "Space X", "Space Exploration Technologies", "Space Exploration Technologies Corp.", "Space Exploration Technologies Corporation", "Crew Dragon", "Starlink"],
